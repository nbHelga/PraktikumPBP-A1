<?php
    ...
    function hitung_diskon2($harga,$diskon=10){ //kalau mau membuat diskon defaultnya tu 10%
        $harga = $harga - ($harga*$diskon/100);
        return $harga;
    }
    //contoh pemanggilan fungsi
    ...
    $diskon = 20;
    echo 'Harga sebelum diskon = '.$harga.'<br />';
    hitung_diskon3($harga, $diskon); //yang beda sama fungsi 2 cuman cara pemanggilannya saja
